        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ─── 3. QUICK ACTIONS (ALL BUTTONS IN LINE) ──────────────────────────
              Row(
              ...
              // All Quick Action Buttons arranged strictly in a single horizontal line
              SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                physics: const BouncingScrollPhysics(),
                child: Row(
                  children: [
                    _QuickActionInlineButton(
...
class _QuickActionInlineButton extends StatelessWidget {
  final String title;
  final IconData icon;
  final Color iconBg;
  final Color iconColor;
  ...
  const _QuickActionInlineButton({
    required this.title,
    required this.icon,
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(Icons.arrow_forward_rounded, size: 13, color: accentColor),
                ),
              ],
            ),
            Text(
